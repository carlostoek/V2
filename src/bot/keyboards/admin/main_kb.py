"""
Sistema de Menús de Administración Unificado - Archivo Principal
🛠️ Menú principal con estructura 2x3 y navegación lineal
Conserva imports existentes para compatibilidad
"""
...
# ============================================
# FUNCIONES PRINCIPALES PARA COMPATIBILIDAD
# ============================================

async def get_channel_name(channel_type: str) -> str:
    """Obtiene el nombre del canal VIP o Free configurado."""
    return await admin_menu_system.get_channel_name(channel_type)
